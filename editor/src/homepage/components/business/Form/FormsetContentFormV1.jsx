...
const MyForm = () => {
  ...
  const handleSubmit = async (values) => {
    ...
    formData.append('component', 'FormsetStepsV1');
  ...
  const initialValues = {
    inputs: dataForm?.length > 0
      ...
      : { parent: { id: '', title: '', subtitle: '', main_image: '' }, child: [{ title_bullet: '', content_bullet: '', numbers: '', content_type: 'experience' }] },
  };
          ...
          {({ values, errors }) => (
            <Form className="mb-5">
              <h3 className="text-lg text-center font-bold text-slate-800 font-oxanium">
                Objetivo: Sección Steps Llenar Campos (Requerido)
              </h3>
              {errors.inputs && (
