...
import { Input } from '../../../components/business/Form/Form'
import FooterMenu, { Footer } from '../../../components/business/Footers/Footer';
import InViewPort from '../../../components/business/InViewPort';
import StelaEditor from '../../../components/sidebar/StelaEditor';
import EditorButton from '../../../components/business/Button/EditorButton';
import FooterData from '../../../components/business/Footers/FooterData';
import { pricingTable03MonthData, pricingTable03YearData } from "../../../components/business/PricingTable/PricingTableData";
import { IconWithTextData_06 } from "../../../components/business/IconWithText/IconWithTextData";
import { blogData } from "../../../components/business/Blogs/BlogData";

const IconWithText = lazy(() => import('../../../components/business/IconWithText/IconWithText'))
const HamburgerMenu = React.lazy(() => import("../../../components/business/Header/Header").then((module) => ({ default: module.HamburgerMenu })))
const Header = React.lazy(() => import("../../../components/business/Header/Header").then((module) => ({ default: module.Header })))
const HeaderNav = React.lazy(() => import("../../../components/business/Header/Header").then((module) => ({ default: module.HeaderNav })))
const Menu = React.lazy(() => import("../../../components/business/Header/Header").then((module) => ({ default: module.Menu })))
const SearchBar = React.lazy(() => import("../../../components/business/Header/Header").then((module) => ({ default: module.SearchBar })))

const Buttons = lazy(() => import('../../../components/business/Button/Buttons'))
const InteractiveBanners02 = lazy(() => import('../../../components/business/InteractiveBanners/InteractiveBanners02'))
const ProcessStep = lazy(() => import('../../../components/business/ProcessStep/ProcessStep'))
const Overlap = lazy(() => import('../../../components/business/Overlap/Overlap'))
const PricingTable03 = lazy(() => import('../../../components/business/PricingTable/PricingTable03'))
const ReactCustomScrollbar = lazy(() => import("../../../components/business/ReactCustomScrollbar"))
const BlogMasonry = lazy(() => import('../../../components/business/Blogs/BlogMasonry'))
const MessageBox = lazy(() => import('../../../components/business/MessageBox/MessageBox'))
const SocialIcons = lazy(() => import("../../../components/business/SocialIcon/SocialIcons"))
const SideButtons = lazy(() => import("../../../components/business/SideButtons"))
const StaticInstagram = lazy(() => import('../../../components/business/Instagram/StaticInstagram'))
const TiltBox = lazy(() => import('../../../components/business/FancyText/FancyText').then(module => ({ default: module.TiltBox })))
...
const logoData = {
  defaultLogo: {
    ...
    retinaSrc: '/assets/img/webp/logo-white@2x.webp',
    alt: 'logo',
    width: 111,
    height: 36
  },
  altLogo: {
    ...
    retinaSrc: '/assets/img/webp/logo-green-dark@2x.webp',
    alt: 'logo',
    width: 111,
    height: 36
  },
    ...
    <div style={props.style}>
          ...
          <Col lg={2} sm={6} xs={"auto"} className="mr-auto ps-0">
            <Link aria-label="header logo" className="flex items-center" to="/">
              ...
              <img
                ...
                width={logoData.defaultLogo.width}
                height={logoData.defaultLogo.height}
                src={logoData.defaultLogo.src}
                data-rjs={logoData.defaultLogo.retinaSrc}
                alt={logoData.defaultLogo.alt}
              />
              <img
                className="alt-logo"
                width={logoData.altLogo.width}
                height={logoData.altLogo.height}
                src={logoData.altLogo.src}
                data-rjs={logoData.altLogo.retinaSrc}
                alt={logoData.altLogo.alt}
              />
              <img
                className="mobile-logo"
                width={logoData.mobileLogo.width}
                height={logoData.mobileLogo.height}
                src={logoData.mobileLogo.src}
                data-rjs={logoData.mobileLogo.retinaSrc}
                alt={logoData.mobileLogo.alt}
              />
              </Navbar.Brand>
            </Link>
          </Col>
      ...
      <InViewPort>
        ...
        <section className="sm:pt-[50px] mb-[130px] md:mb-[50px] sm:mb-0 inline-block w-full">
          <Overlap>
          <EditorButton onClick={() => switchForm('experienceForm')} />
            <m.img
