        ...
        <section className="bg-darkgray home-startup-swiper">
            <LazyMotion strict features={domMax}>
                <Swiper
                    ...
                    className="startup swiper-navigation-04 swiper-navigation-light swiper-pagination-03 swiper-pagination-light swiper-pagination-medium sm-nav-hidden h-[100vh]">
                            ...
                            <SwiperSlide key={i} className="overflow-hidden">
                                ...
                                <Container className="text-center">
                                    <Row className="full-screen items-center justify-center md:landscape:h-[500px]">
                                        <Col xs={12} lg={7} md={10} className="justify-center items-center my-0 mx-auto relative flex flex-col h-[100vh]">
