        ...
        subcategory: [
            ...
            },
            {
                ...
                subcategory: [
                    ...
                    {
                        id: 111,
                        name: "Imagen Estática",
                        subcategory: [
                            { id: 1111, name: "Con Texto" },
                            { id: 1112, name: "Sin Texto" }
                        ],
        ...
        subcategory: [
            ...
            },
            {
                ...
                subcategory: [
                    ...
                    },
                    {
                        ...
                        name: "Grid",
                        subcategory: [
                            { id: 2111, name: "2 Columnas" },
                            { id: 2112, name: "3 Columnas" },
                            { id: 2113, name: "4 Columnas" }
                        ]
                    },
                    {
                        id: 212,
                        name: "Lista",
                        subcategory: [
                            { id: 2121, name: "Con Sidebar" },
                            { id: 2122, name: "Sin Sidebar" }
                        ]
                    }
                ]
            },
            {
                ...
                subcategory: [
                    {
                        id: 0,
                        name: "Seleccionar layout",
                        disabled: true,
                        subcategory: []
                    },
                    {
                        id: 221,
                        name: "Imagen a la Izquierda",
                        subcategory: [
                            { id: 2211, name: "Una Imagen" },
                            { id: 2212, name: "Galería" }
                        ]
                    },
                    {
                        id: 222,
                        name: "Imagen Arriba",
                        subcategory: [
                            { id: 2221, name: "Tabs de Información" },
                            { id: 2222, name: "Acordeón de Información" }
                        ]
                    }
                ]
            }
            ...
            },
            {
                ...
                subcategory: [
                    ...
                    },
                    {
                        ...
                        name: "Grid",
                        subcategory: [
                            { id: 3111, name: "2 Columnas" },
                            { id: 3112, name: "3 Columnas" }
                        ]
                    },
                    {
                        id: 312,
                        name: "Lista",
                        subcategory: [
                            { id: 3121, name: "Con Imagen Destacada" },
                            { id: 3122, name: "Sin Imagen Destacada" }
                        ]
                    }
                ]
            },
            {
                ...
                subcategory: [
                    ...
                    },
                    {
                        ...
                        subcategory: [
                            { id: 3211, name: "Con Sidebar" },
                            { id: 3212, name: "Ancho Completo" }
                        ]
                    },
                    {
                        id: 322,
                        name: "Comentarios",
                        subcategory: [
                            { id: 3221, name: "Habilitados" },
                            { id: 3222, name: "Deshabilitados" }
                        ]
                    }
                ]
            }
            ...
            },
            {
                ...
                subcategory: [
                    ...
                    },
                    {
                        ...
                        name: "Básico",
                        subcategory: [
                            { id: 4111, name: "Con Captcha" },
                            { id: 4112, name: "Sin Captcha" }
                        ]
                    },
                    {
                        id: 412,
                        name: "Avanzado",
                        subcategory: [
                            { id: 4121, name: "Multi-paso" },
                            { id: 4122, name: "Con Adjuntos" }
                        ]
                    }
                ]
            },
            {
                ...
                subcategory: [
                    ...
                    },
                    {
                        ...
                        name: "Mapa",
                        subcategory: [
                            { id: 4211, name: "Google Maps" },
                            { id: 4212, name: "OpenStreetMap" }
                        ]
                    },
                    {
                        id: 422,
...
export function findById(array, id) {
    for (let i = 0; i < array.length; i++) {
      ...
      if (element.id === id) {
        ...
        const found = findById(element.subcategory, id);
        if (found) {
          return found;
        }
      }
