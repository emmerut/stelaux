...
const notifyLabel = ({counter}) => {
  return (
    counter == null ? (
      <SkeletionAvatar width="lg:h-[32px] lg:w-[32px]" />
    ) : (
      <span
      ...
      >
        ...
        <span
          className="absolute lg:right-0 lg:top-0 -top-2 -right-2 h-4 w-4 bg-red-500 text-[8px] font-semibold flex flex-col items-center justify-center rounded-full text-white z-[99]"
        >
          {counter}
        </span>
      </span>
...
const Notification = ({counter}) => {
  return (
    <Dropdown classMenuItems="md:w-[300px] top-[58px]" label={notifyLabel({counter})}>
