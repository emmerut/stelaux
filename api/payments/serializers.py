...
class PaymentIntentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PaymentIntent
        fields = ['id', 'status', 'transaction_type', 'user', 'product_name', 'client_secret', 'amount', 'currency', 'annually', 'created_at', 'updated_at', 'fee_amount', 'total_amount', 'payment_method']  # Add 'payment_method' to the fields
    ...
    def get_total_amount(self, obj):
        ...
        return (obj.amount + self.get_fee_amount(obj)).quantize(Decimal('0.00'))  # Round to 2 decimal places
