...
import Piechart from '../../../components/business/PieChart/Piechart';
import Testimonials from '../../../components/business/Testimonials/Testimonials';
import Tab01 from '../../../components/business/Tab/Tab01';
import Counter from '../../../components/business/Counters/Counter'
...
import CustomModal from '../../../components/business/CustomModal'
import Header, { HeaderLanguage, HeaderNav, Menu, SearchBar, Topbar } from '../../../components/business/Header/Header';
import FooterMenu, { Footer } from '../../../components/business/Footers/Footer';
import SideButtons from "../../../components/business/SideButtons";

// Data
import { InteractiveBannersData02 } from '../../../components/business/InteractiveBanners/InteractiveBannersData';
import { TabData01 } from '../../../components/business/Tab/TabData';
import { IconWithTextData_02 } from '../../../components/business/IconWithText/IconWithTextData';
import { TestimonialsData03 } from '../../../components/business/Testimonials/TestimonialsData';
          ...
          <Row className="justify-center">
            <m.div className="col-xl-3 col-lg-4 col-sm-7 flex flex-col md:mb-24" {...{ ...fadeIn, transition: { delay: 0.2 } }}>
              ...
              <div className="mt-auto mx-auto mx-lg-0">
                <Buttons href="/" className="text-slate-800 font-medium font-serif uppercase bg-[#fff] hover:bg-black rounded-none md:mb-[15px] text-xxs btn-fancy xs:mb-0" size="sm" themeColor="#000" title="Discover litho" />
              </div>
            </m.div>
          ...
          <Container>
            <Row className="justify-center md:block">
              <Col lg={5} sm={9} className="text-left flex-col items-start flex md:text-center md:my-0 md:mx-auto md:mb-[70px] md:items-center sm:mb-[65px]">
                ...
                <Buttons href="/" className="text-slate-800 font-medium font-serif uppercase rounded-none bg-[#fff] hover:bg-black md:mb-[15px] mt-[38px] sm:my-0 sm:mx-auto" size="sm" themeColor="#000" title="Discover litho" />
              </Col>
              <Col lg={{ offset: 1 }}>
                <Piechart
